function results = sar_jihai(y,x,W,info)
...
% ---------------------------------------------------
%  USAGE: results = sar_jihai(y,x,W,info)
...
results.lik = f2_sar_jihai(parm,y,x,W,detval,info_f2);
...
results.lik1 = f2_sar_jihai(theta1,y,x,W,detval,info_f2); %Added J.P.Elhorst, 31-3-2016

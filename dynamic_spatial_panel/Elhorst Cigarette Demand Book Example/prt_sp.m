...
case ('semautsre')
fprintf(fid,'Pooled model with spatial and serial error autocorrelation and spatial random effects \n');
case {'psac'}
fprintf(fid,'Pooled model with spatial lagged dependent variable and spatial error autocorrelation, no fixed effects \n');
case {'sacsfe'}
fprintf(fid,'Pooled model with spatial lagged dependent variable and spatial error autocorrelation, spatial fixed effects \n');
case {'sactfe'}
fprintf(fid,'Pooled model with spatial lagged dependent variable and spatial error autocorrelation, time period fixed effects \n');
case {'sacstfe'}
fprintf(fid,'Pooled model with spatial lagged dependent variable and spatial error autocorrelation, spatial and time period fixed effects \n');
otherwise
...
case ('semautsre')     % <=================== random effects spatial + serial error model

results.fe=0;
% add spatial rho parameter name and teta
    Vname = strvcat(Vname,'spatial aut.','serial aut.','teta');
...
case {'psac','sacsfe','sactfe','sacstfe'} % <=================== fixed effects spatial lag/spatial error model

% add spatial parameter names
    Vname = strvcat(Vname,'rho','spat.aut.');
